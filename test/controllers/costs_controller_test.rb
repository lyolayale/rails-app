...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference("Cost.count") do
      post costs_url, params: { cost: { age: @cost.age, body: @cost.body, fav_color: @cost.fav_color, title: @cost.title } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { age: @cost.age, body: @cost.body, fav_color: @cost.fav_color, title: @cost.title } }
